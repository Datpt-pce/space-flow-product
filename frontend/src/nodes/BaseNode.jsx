...
export default function BaseNode({ id, data, selected, width }) {
  ...
  // Node có field config kiểu "file" (vd. load-image) → thả file từ Explorer thẳng
  // lên node để set path thật, không upload. Field nào khai type "file" trong
  // node.json sẽ tự động có drop-zone này.
