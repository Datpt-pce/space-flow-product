              ...
              <div className="overflow-auto flex-1 min-h-0 rounded-lg border border-[var(--card-border,#f3f4f6)]">
                <table className="w-full text-[9px] border-collapse">
                  ...
                  <tbody>
                    ...
                    {rows.length === 0 && (
                      <tr><td colSpan={15} className="text-center text-[var(--n400,#9ca3af)] py-4">Chưa có dòng nào. Bấm &quot;Thêm dòng&quot; để bắt đầu.</td></tr>
                    )}
                  </tbody>
                </table>
              </div>
        ...
        <Modal title="Cài đặt chung" width={420} onClose={() => setSettingsOpen(false)}>
          <div className="flex flex-col gap-3">
            ...
            <div>
              ...
              <button className="w-full mt-1 py-1 rounded-md bg-[var(--n100,#f3f4f6)] text-[9px] font-semibold text-[var(--sub,#4b5563)] hover:bg-[var(--n200,#e5e7eb)]" onClick={() => setChannelManagerOpen(true)}>Quản lý Kênh Google…</button>
            </div>

            <div>
              <div className={labelCls}>Quản lý App</div>
              <button className="w-full py-1 rounded-md bg-[var(--n100,#f3f4f6)] text-[9px] font-semibold text-[var(--sub,#4b5563)] hover:bg-[var(--n200,#e5e7eb)]" onClick={() => setAppManagerOpen(true)}>Quản lý App (UNC)…</button>
            </div>
          </div>
        </Modal>
      )}
