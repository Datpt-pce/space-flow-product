    ...
    >
      ...
      <div className="absolute top-0 left-0 right-0 flex items-center justify-between px-4 py-3 pointer-events-none">
        ...
        <div className="flex items-center gap-2 pointer-events-auto">
          <button
            className="w-7 h-7 rounded-lg flex items-center justify-center text-white/60 hover:text-white hover:bg-[var(--card,#fff)]/10 transition-colors"
            onClick={() => zoom(-0.25)}
            title="Thu nhỏ"
          >
            <ZoomOut size={14} />
          ...
          <div className="w-px h-4 bg-[var(--card,#fff)]/20 mx-1" />
          <button
            className="w-7 h-7 rounded-lg flex items-center justify-center text-white/60 hover:text-white hover:bg-[var(--card,#fff)]/10 transition-colors"
