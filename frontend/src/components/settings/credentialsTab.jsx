...
import GoogleReportingConnection from '../GoogleReportingConnection.jsx';

const CREDENTIAL_TYPES = [
  { value: 'google-apps-script', label: 'Google Apps Script', fields: [{ key: 'web_app_url', label: 'Web App URL (https://script.google.com/macros/s/.../exec)' }, { key: 'token', label: 'Secret Key (ít nhất 32 ký tự)', type: 'password' }] },
...
export function CredentialsTab() {
  ...
  return (
    <div className="flex flex-col gap-6 py-1">
      <GoogleReportingConnection onConnected={load} />
      <div>
