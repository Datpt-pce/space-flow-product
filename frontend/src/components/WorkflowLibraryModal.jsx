...
export default function WorkflowLibraryModal() {
  ...
  return (
    <div
      className="sf-motion-backdrop fixed inset-0 z-[9999] flex items-center justify-center"
      style={{ background: 'rgba(0,0,0,0.3)' }}
      onMouseDown={(e) => { if (e.target === e.currentTarget) closeWorkflowLibrary(); }}
    >
      <div className="sf-motion-dialog bg-[var(--card,#fff)] rounded-2xl shadow-2xl border border-[var(--card-border,#e5e7eb)] flex flex-col overflow-hidden"
