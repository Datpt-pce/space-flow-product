...
export default function FlowCanvas() {
  ...
  const designMode = useStore(s => s.appearanceSettings.designMode);
  const nodeTypes = useMemo(() => buildNodeTypes(Object.values(nodeManifests), designMode), [nodeManifests, designMode]);
