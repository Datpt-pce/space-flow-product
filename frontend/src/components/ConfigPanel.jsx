...
import NodeHistoryScope, { NodeHistoryControls } from './NodeHistoryScope.jsx';
...
export default function ConfigPanel() {
  ...
  return (
    <NodeHistoryScope nodeId={node.id}
      className="sf-motion-panel absolute z-40 bg-[var(--card,#fff)] border border-[var(--card-border,#e5e7eb)] rounded-2xl shadow-xl flex flex-col overflow-hidden"
    ...
    >
      ...
      {/* Config fields */}
      <div className="px-3"><NodeHistoryControls nodeId={node.id} /></div>
