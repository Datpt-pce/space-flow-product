...
export default function VersionBell() {
  ...
  const isUpToDate = !!agentVersion && agentVersion === versionInfo.version;
  ...
  const handleUpdateAgent = async () => {
    track('agent_update_requested', {}, { feature: 'admin' });
          ...
          {agentAvailable && (
            <div className="border-t border-[var(--card-border,#f3f4f6)] mt-3 pt-3">
              <button
                ...
                disabled={updateStatus === 'running' || isUpToDate}
              ...
              >
                ...
                {updateStatus === 'running' ? 'Đang cập nhật...' : isUpToDate ? 'Đã cập nhật' : 'Cập nhật Agent'}
              </button>
              {updateStatus === 'done' && (
