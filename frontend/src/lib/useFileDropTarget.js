...
// Dùng chung cho ListNodeBeta và (khi cần) các node khác nhận file thả trực tiếp lên card.
// resolveDropPaths() tự xử lý cả internal drag (từ MediaNode, dataTransfer 'space-flow-file')
// lẫn OS drop (Windows Explorer), không cần tách nhánh thủ công.
