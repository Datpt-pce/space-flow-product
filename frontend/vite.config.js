...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@shared/video-batch-planner': path.resolve(__dirname, '../shared/video-batch-planner.js'),
      '@shared/video-caption-layout': path.resolve(__dirname, '../shared/video-caption-layout.js'),
      '@shared/video-speech': path.resolve(__dirname, '../shared/video-speech.js'),
      '@shared/creative-assistant': path.resolve(__dirname, '../shared/creative-assistant.js'),
      '@shared/video-transition-timing': path.resolve(__dirname, '../shared/video-transition-timing.js'),
    },
  },
  optimizeDeps: {
    include: ['@shared/video-commands', '@shared/video-transform', '@shared/video-vector', '@shared/video-mask', '@shared/video-chroma', '@shared/video-keyframes', '@shared/video-document-diff', '@shared/video-compound', '@shared/video-batch-planner', '@shared/video-transition-timing', '@shared/video-speech', '@shared/video-caption-layout', '@shared/creative-assistant'],
  },
  build: {
    commonjsOptions: {
      ...
      include: [/shared\/video-commands/, /shared\/video-transform/, /shared\/video-vector/, /shared\/video-mask/, /shared\/video-chroma/, /shared\/video-keyframes/, /shared\/video-document-diff/, /shared\/video-compound/, /shared\/video-batch-planner/, /shared\/video-transition-timing/, /shared\/video-speech/, /shared\/video-caption-layout/, /shared\/creative-assistant/, /node_modules/],
    },
  },
  server: {
    port: frontendPort,
    strictPort: true, // bao loi ro rang neu port dang bi chiem, khong am tham nhay port khac
    host: process.env.SF_BIND_HOST || true,
    allowedHosts,
    proxy: {
      '/api': backendUrl,
      '/uploads': backendUrl,
