...
const upload = multer({ storage: multer.memoryStorage(), limits: { fileSize: 50 * 1024 * 1024, files: 1, fields: 8, parts: 9, fieldSize: 8192, fieldNestingDepth: 2 } });
...
const SUBMISSIONS_ROOT = require('../utils/dataPaths').submissions;
