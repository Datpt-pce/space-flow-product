...
function stop() { for (const timer of timers) clearInterval(timer); timers.length = 0; }
module.exports = { enqueueReindex, processQueue, checkConsistency, runConsistencyCheck, start, stop };
