...
// For "loose bag" nodes (list, batch-create-folder) whose entries are a mix of bare file path
// strings and plain JSON records — coerce either direction without guessing wrong (already-wrapped
